...
# COMMENT: Можно сократить ддо одного print + f-строки вместо формата
print(f"Player 1 ({player_1_score}) win!" if player_1_score > player_2_score else f"Player 2 ({player_2_score}) win!")
